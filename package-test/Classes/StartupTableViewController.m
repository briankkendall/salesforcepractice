...
- (void)viewDidLoad {
    ...
    self.data = @[@"Warehouse", @"FileShare"];
    cellIdentifier = @"rowCell";
    
    [self.PickerTableview registerClass:[UITableViewCell class] forCellReuseIdentifier:cellIdentifier];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row == 0) {
        ...
        FileShareTableViewController *vc = [[FileShareTableViewController alloc] init];
        [self.navigationController pushViewController:vc animated:YES];
    }
}
